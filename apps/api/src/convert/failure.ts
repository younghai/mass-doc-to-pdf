...
export function errorMessage(err: unknown): string {
  ...
  switch (failureReason(message)) {
    case "password_protected":
      return "암호 문서: 암호를 해제한 파일로 다시 업로드하세요.";
    case "unsupported_format":
      return "엔진 미지원: 현재 변환 엔진이 이 문서 구조를 지원하지 않습니다.";
    case "timeout":
      return "렌더링 시간 초과: 파일을 나누거나 정밀 변환으로 다시 시도하세요.";
    case "corrupt_file":
      return "파일 손상 의심: 원본을 다시 저장한 뒤 업로드하세요.";
    case "too_large":
      return "파일 크기 초과: 파일을 나눠 업로드하세요.";
    case "unknown":
      return "파일명 길이 또는 문서 구조 문제: 파일명을 짧게 바꾸고 다시 시도하세요.";
    case "engine_error":
      return "렌더링 실패: 다른 품질 모드로 재시도하거나 원본 문서를 다시 저장하세요.";
    case "quality_gate_failed":
      return "품질 게이트 실패: PDF가 생성됐지만 원본 서식 보존 엔진 결과가 아니어서 다운로드를 막았습니다. LibreOffice/H2Orestart 또는 정밀 엔진을 연결한 뒤 재시도하세요.";
  }
}
